<?php
  ...
  $css    = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/parts/styles/triangular/90deg/gate5.css");
  $a1 = '';
  $a2 = '';
  $b2 = '';
...
<!--<link rel='stylesheet' id='pdf-stylesheet-css' href='--><?php //=$_SERVER['APP_URL']?><!--/parts/styles/triangular/90deg/gate5.css' type='text/css' media='all' />-->
...
<?php endif;
if (strrpos($pages, "4")) : ?>
	<div id="pf4" class="pf w4 hb" data-page-no="4" style="transform: rotate(90deg) scale(1.1) translate(0, -5%); transform-origin: center;">
		<div class="watermark">novi-vorota.com.ua</div>
