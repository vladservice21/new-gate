...
.svg-line4 {
    ...
    top: 65.71%;
    left: <?=($start_gate1)?>px;
    width: <?=(($result_left1)-141)?>px!important;
    height: 1px!important;
    z-index: 3;
}
...
.svg-line2_4 {
    ...
    top: 63.71%;
    left: <?=($start_gate2)?>px;
    width: <?=(($result_left2)-109)?>px!important;
    height: 1px!important;
    z-index: 3;
}
