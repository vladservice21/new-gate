...
<?php
  ...
  $css    = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/parts/styles/triangular/45deg/gate4.css");
  $a1 = '';
  $a2 = '';
  $b2 = '';
...
.svg-line4 {
    ...
    top: 61.71%;
    left: <?=($start_gate1)?>px;
    width: <?=(($result_left1)-54)?>px!important;
    height: 0px!important;
    z-index: 3;
}
...
<!--<link rel='stylesheet' id='pdf-stylesheet-css' href='--><?php //=$_SERVER['APP_URL']?><!--/parts/styles/triangular/45deg/gate4.css' type='text/css' media='all' />-->
...
<?php endif;
if (strrpos($pages, "3")) : ?>
	<div id="pf3" class="pf w4 h9" data-page-no="3" style="transform: scale(0.70); transform-origin: 18% 1%;">
		<div class="watermark">novi-vorota.com.ua</div>
...
<?php endif;
if (strrpos($pages, "4")) : ?>
	<div id="pf4" class="pf w6 he" data-page-no="4" style="margin-top: -350px;">
		<div class="watermark">novi-vorota.com.ua</div>
