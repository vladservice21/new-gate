...
<?php
  ...
  $css    = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/parts/styles/triangular/45deg/gate2.css");
  $a1 = '';
  $a2 = '';
  $b2 = '';
...
.svg-line1 {
    ...
    top: 13.5641%;
    left: <?=($result_left1+26)?>px;
    width: 126.0px!important;
...
.svg-line4 {
    ...
    top: 65.71%;
    left: <?=($start_gate1)?>px;
    width: <?=(($result_left1)-70)?>px!important;
    height: 0px!important;
    z-index: 3;
}
...
.svg-line2_4 {
    ...
    top: 63.71%;
    left: <?=($start_gate2)?>px;
    width: <?=(($result_left2)-92)?>px!important;
    height: 0px!important;
    z-index: 3;
}
...
<!--<link rel='stylesheet' id='pdf-stylesheet-css' href='--><?php //=$_SERVER['APP_URL']?><!--/parts/styles/triangular/45deg/gate2.css' type='text/css' media='all' />-->
