...
<?php
  ...
  $css    = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/parts/styles/square/45deg/gate2.css");
  if($wicket == 'on') {
  $start_gate1 = 135;
  $pillar1 = 155;
  $image_width1 = 890.09;
...
<!--<link rel='stylesheet' id='pdf-stylesheet-css' href='--><?php //=$_SERVER['APP_URL']?><!--/parts/styles/square/45deg/gate2.css' type='text/css' media='all' />-->
...
<?php endif;
if (strrpos($pages, "3")) : ?>
	<div id="pf3" class="pf w4 h8" data-page-no="3" style="transform: scale(0.70); transform-origin: 18% 1%;">
		<div class="watermark">novi-vorota.com.ua</div>
...
<?php endif;
if (strrpos($pages, "4")) : ?>
	<div id="pf4" class="pf w6 hd" data-page-no="4" style="margin-top: -350px;">
		<div class="watermark">novi-vorota.com.ua</div>
