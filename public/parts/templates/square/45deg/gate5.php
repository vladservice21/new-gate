...
<?php
  ...
  $css    = file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/parts/styles/square/45deg/gate5.css");
  if($wicket == 'on') {
  $start_gate1 = 65;
  $pillar1 = 155;
  $image_width1 = 1032.78;
  $result_left1 = $image_width1/$manual_a*$wicket_left+$start_gate1;

  $start_gate2 = 135;
  $pillar2 = 155;
  $image_width2 = 1484.59;
...
.svg-line4 {
    ...
    top: 63.71%;
    left: <?=($start_gate1)?>px;
    width: <?=(($result_left1)-49)?>px!important;
    height: 1px!important;
    z-index: 3;
}
...
.svg-line2_4 {
    ...
    top: 53.71%;
    left: <?=($start_gate2)?>px;
    width: <?=(($result_left2)-126)?>px!important;
    height: 1px!important;
    z-index: 3;
}
...
<!--<link rel='stylesheet' id='pdf-stylesheet-css' href='--><?php //=$_SERVER['APP_URL']?><!--/parts/styles/square/45deg/gate5.css' type='text/css' media='all' />-->
...
<?php endif;
if (strrpos($pages, "4")) : ?>
	<div id="pf4" class="pf w6 hf" data-page-no="4"  style="transform: rotate(90deg) scale(1.1) translate(0, -5%); transform-origin: center;">
		<div class="watermark">novi-vorota.com.ua</div>
