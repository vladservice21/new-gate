<x-admin.wrapper>
    ...
    <div>
        <x-admin.breadcrumb href="{{route('admin.user.index')}}" title="{{ __('Створити користувача') }}">{{ __('<< Назад до всіх користувачів') }}</x-admin.breadcrumb>
        <x-admin.form.errors />
    </div>
    <div class="w-full py-2 overflow-hidden">
        ...
        @csrf
            ...
            <div class="flex justify-end mt-4">
                <x-admin.form.button>{{ __('Створити') }}</x-admin.form.button>
            </div>
        </form>
    </div>
</x-admin.wrapper>
