...
class ApiController extends Controller
{
    ...
    public function viewpdf($id) {
		...
		if ($counterweight_type == "square") {
  			if ( $pipe_angle == 45 ) {
  			  $result = $this->include_file($_SERVER['DOCUMENT_ROOT'] . "/parts/templates/square/45deg/gate" . $gate_num_square .".php", $counterweight_type, $material, $gate_opening, $gate_height, $clearance_under_gate, $guide, $manual_a, $pages, $pipe_angle, $gate_num_triang, $gate_num_square);
  			} else if ( $pipe_angle == 90 ) {
  			  $result = $this->include_file($_SERVER['DOCUMENT_ROOT'] . "/parts/templates/square/90deg/gate" . $gate_num_square .".php", $counterweight_type, $material, $gate_opening, $gate_height, $clearance_under_gate, $guide, $manual_a, $pages, $pipe_angle, $gate_num_triang, $gate_num_square);
  			}
		} else {
  			if ( $pipe_angle == 45 ) {
  			  $result = $this->include_file($_SERVER['DOCUMENT_ROOT'] . "/parts/templates/triangular/45deg/gate" . $gate_num_triang .".php", $counterweight_type, $material, $gate_opening, $gate_height, $clearance_under_gate, $guide, $manual_a, $pages, $pipe_angle, $gate_num_triang, $gate_num_square);
  			} else if ( $pipe_angle == 90 ) {
  			  $result = $this->include_file($_SERVER['DOCUMENT_ROOT'] . "/parts/templates/triangular/90deg/gate" . $gate_num_triang .".php", $counterweight_type, $material, $gate_opening, $gate_height, $clearance_under_gate, $guide, $manual_a, $pages, $pipe_angle, $gate_num_triang, $gate_num_square);
  			}
		}
    ...
    public function include_file($file, $counterweight_type, $material, $gate_opening, $gate_height, $clearance_under_gate, $guide, $manual_a, $pages, $pipe_angle, $gate_num_triang, $gate_num_square) {
    	ob_start();
    	include($file);
    	return ob_get_clean();
    }
